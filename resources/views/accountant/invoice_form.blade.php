...
@section('page_subtitle','Add new customer invoice')
@section('sidebar_nav')
...
<div class="d-flex justify-content-between mb-4">
    <a href="{{ route('accountant.account_receivable') }}" class="btn btn-outline-secondary px-3">
        <i class="fas fa-arrow-left me-2"></i>Back
    </a>
    <h6 class="mb-0" style="color:var(--green-dark);font-weight:700;align-self:center">
        <i class="fas fa-file-invoice-dollar me-2" style="color:#0369a1"></i>New Invoice — {{ $nextNumber }}
    </h6>
</div>
...
<form method="POST" action="{{ route('accountant.account_receivable.store') }}" id="invoiceForm">
@csrf
<div class="row g-4">
    {{-- Left: Header --}}
    <div class="col-lg-8">
        <div class="chart-card mb-4">
            <h6 class="mb-3" style="color:var(--green-dark);font-weight:700"><i class="fas fa-info-circle me-2"></i>Invoice Details</h6>
            <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <label class="form-label" style="font-size:.8rem;font-weight:600;color:#374151">Invoice Date <span class="text-danger">*</span></label>
                ...
                <table class="table" id="linesTable">
                    ...
                    <tbody id="linesBody">
                        <tr class="line-row">
                            ...
                            <td><input type="text" class="form-control form-control-sm amount-display" value="0.00" readonly style="background:#f9fafb;font-weight:600;color:#0369a1"></td>
    ...
    <div class="col-lg-4">
        <div class="chart-card" style="position:sticky;top:80px">
            ...
            <div class="d-flex justify-content-between mb-4" style="font-size:1rem">
                ...
                <strong id="totalDisplay" style="color:#0369a1;font-size:1.1rem">RM 0.00</strong>
            </div>
            <button type="submit" class="btn btn-green w-100 py-2" style="font-size:.9rem">
                <i class="fas fa-save me-2"></i>Create Invoice
            </button>
            <a href="{{ route('accountant.account_receivable') }}" class="btn btn-outline-secondary w-100 mt-2 py-2" style="font-size:.9rem">
